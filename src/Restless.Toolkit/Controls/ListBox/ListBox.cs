...
namespace Restless.Toolkit.Controls
{
    ...
    {
        #region Private
        private System.Windows.Controls.ScrollViewer outerScrollViewer;
        #endregion
        ...
        public static readonly DependencyProperty RightClickSelectionProperty = DependencyProperty.Register
            (
                nameof(RightClickSelection), typeof(bool), typeof(ListBox), new FrameworkPropertyMetadata(false)
            );
        ...
        /// <remarks>
        /// <para>
        /// If <see cref="ListBox"/> is contained within an outer scroll viewer
        ...
        public static readonly DependencyProperty UseOuterScrollViewerProperty = DependencyProperty.Register
            (
                nameof(UseOuterScrollViewer), typeof(bool), typeof(ListBox), new FrameworkPropertyMetadata(false)
            );
        #endregion
        ...
        /// a <see cref="ListBox"/> object that surpresses the right click. Otherwise,
        ...
        private System.Windows.Controls.ScrollViewer GetOuterScrollViewer()
        {
            if (outerScrollViewer == null)
            {
                outerScrollViewer = CoreHelper.GetVisualParent<System.Windows.Controls.ScrollViewer>(this);
            }
